...
export class CommentSection extends Component<{comments : Comment[], newComment : Comment, onClick : (event: SyntheticInputEvent<HTMLFormElement>) => mixed, onDelete : (event: SyntheticInputEvent<HTMLFormElement>) => mixed}>{
